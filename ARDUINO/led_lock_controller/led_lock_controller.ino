...
// DEBUG: Tempo reduzido para testes (3-5 segundos)
unsigned long MIN_COLOR_DURATION = 3000;   // 3 segundos (em ms) - DEBUG - voltar para 15000
unsigned long MAX_COLOR_DURATION = 5000;   // 5 segundos (em ms) - DEBUG - voltar para 30000
